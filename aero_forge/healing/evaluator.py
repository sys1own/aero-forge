...
class LogEvaluator:
    ...
    CARGO_PATTERNS: List[Tuple[str, str, str]] = [
        ...
        (r"error: could not find `?Cargo\.toml`?", "cargo_manifest_path", None, "Cargo.toml not found in current directory. Add --manifest-path or create a workspace root Cargo.toml."),
        (r"error: manifest path", "cargo_manifest_path", None, "The requested Cargo.toml manifest path is invalid. Update the manifest or execution options."),
